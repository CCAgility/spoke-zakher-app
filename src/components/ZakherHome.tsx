      ...
      <AnimatePresence>
        {isContactOpen && (
          <>
            ...
            >
              <button onClick={() => setIsContactOpen(false)} className="absolute top-8 right-8 text-gray-500 hover:text-white transition-colors duration-300"><X size={28} strokeWidth={1} /></button>
              <h2 className="text-4xl font-cormorant font-light mb-2 tracking-wide">{t.contactForm?.title || "Contact Concierge"}</h2>
              <p className="text-gray-400 font-montserrat text-xs tracking-wide mb-12">{t.contactForm?.subtitle || "How can we assist with your stay?"}</p>
              <form 
