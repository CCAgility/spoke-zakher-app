...
const translations = {
  en: {
    ...
    welcomeTitle: "Welcome to Grupo Zakher",
    welcomeText: "Discover a sanctuary where history and luxury intertwine. Grupo Zakher offers seven exquisite bedrooms, private pools, and lush courtyards, providing an unparalleled retreat in Cartagena. Every detail has been carefully curated to ensure your stay is nothing short of extraordinary.",
  ...
  es: {
    ...
    welcomeTitle: "Bienvenido a Grupo Zakher",
    welcomeText: "Descubra un santuario donde la historia y el lujo se entrelazan. Grupo Zakher ofrece siete exquisitas habitaciones, piscinas privadas y exuberantes patios, brindando un refugio incomparable en Cartagena. Cada detalle ha sido cuidadosamente seleccionado para asegurar que su estadÃ­a sea nada menos que extraordinaria.",
  ...
  pt: {
    nav: { home: "InÃ­cio", casaEstrella: "Casa Estrella de San Pedro", villa: "A Villa", accommodations: "AcomodaÃ§Ãµes", gallery: "Galeria", contact: "Contato" },
    bookNow: "Reservar",
    location: "Cartagena, ColÃ´mbia",
    heroTitle: "Grupo Zakher",
    heroSubtitle: "Experimente a elegÃ¢ncia atemporal de nossa villa colonial, aninhada no coraÃ§Ã£o da cidade histÃ³rica amuralhada.",
    arrival: "Check-in",
    departure: "Check-out",
    ...
    welcomeTitle: "Bem-vindo ao Grupo Zakher",
    welcomeText: "Descubra um santuÃ¡rio onde a histÃ³ria e o luxo se entrelaÃ§am. O Grupo Zakher oferece sete quartos requintados, piscinas privativas e pÃ¡tios exuberantes, proporcionando um retiro inigualÃ¡vel em Cartagena. Cada detalhe foi cuidadosamente selecionado para garantir que sua estadia seja nada menos que extraordinÃ¡ria.",
    aboutTitle: "Sobre a casa",
    amenitiesTitle: "Comodidades",
    amenitiesList: [
      "Ar condicionado", "WiFi",
      "Piscina privativa", "Limpeza diÃ¡ria",
      "Concierge", "CafÃ© da manhÃ£ incluÃ­do",
      "Cozinha totalmente equipada", "Smart TV"
    ],
    showAllAmenities: "Mostrar todas as comodidades",
    rooms: [
      { name: "A Arquitetura", desc: "ElegÃ¢ncia colonial" },
      { name: "O SantuÃ¡rio", desc: "Sete quartos requintados" },
      { name: "O OÃ¡sis", desc: "Piscinas e pÃ¡tios privativos" },
      { name: "O Jantar", desc: "ExcelÃªncia culinÃ¡ria" }
    ],
    discover: "Explorar",
    galleryTitle: "A Villa"
  },
  fr: {
    nav: { home: "Accueil", casaEstrella: "Casa Estrella de San Pedro", villa: "La Villa", accommodations: "HÃ©bergements", gallery: "Galerie", contact: "Contact" },
    bookNow: "RÃ©server",
    location: "CarthagÃ¨ne, Colombie",
    heroTitle: "Grupo Zakher",
    heroSubtitle: "DÃ©couvrez l'Ã©lÃ©gance intemporelle de notre villa coloniale, nichÃ©e au cÅ“ur de la ville historique fortifiÃ©e.",
    arrival: "ArrivÃ©e",
    departure: "DÃ©part",
    dates: "SÃ©lectionner les dates",
    guests: "Voyageurs",
    adults: "2 Adultes",
    search: "Voir les disponibilitÃ©s",
    welcomeTitle: "Bienvenue au Grupo Zakher",
    welcomeText: "DÃ©couvrez un sanctuaire oÃ¹ l'histoire et le luxe s'entremÃªlent. Le Grupo Zakher propose sept chambres exquises, des piscines privÃ©es et des cours luxuriantes, offrant une retraite inÃ©galÃ©e Ã  CarthagÃ¨ne. Chaque dÃ©tail a Ã©tÃ© soigneusement sÃ©lectionnÃ© pour que votre sÃ©jour soit tout simplement extraordinaire.",
    aboutTitle: "Ã€ propos de la maison",
    amenitiesTitle: "Ã‰quipements",
    amenitiesList: [
      "Climatisation", "WiFi",
      "Piscine privÃ©e", "MÃ©nage quotidien",
      "Conciergerie", "Petit-dÃ©jeuner inclus",
      "Cuisine entiÃ¨rement Ã©quipÃ©e", "Smart TV"
    ],
    showAllAmenities: "Afficher tous les Ã©quipements",
    rooms: [
      { name: "L'Architecture", desc: "Ã‰lÃ©gance coloniale" },
      { name: "Le Sanctuaire", desc: "Sept chambres exquises" },
      { name: "L'Oasis", desc: "Piscines et cours privÃ©es" },
      { name: "Le DÃ®ner", desc: "Excellence culinaire" }
    ],
    discover: "Explorer",
    galleryTitle: "La Villa"
  }
...
export function GrupoZakher({ lang = 'en' }: { lang?: string }) {
    ...
    <div className="min-h-screen bg-[#F9F9F9] text-[#1A1A1A] font-sans selection:bg-[#8BA3A0] selection:text-white">
      ...
      <section className="relative h-[100vh] w-full overflow-hidden flex flex-col justify-end pb-32 px-8 md:px-16">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <img 
            src="/images/Gemini_Generated_Image_tfksw9tfksw9tfks.png"
            alt="Grupo Zakher Cartagena"
      ...
      <footer className="bg-[#111] text-white py-20 px-6 text-center">
        ...
        <p className="font-montserrat text-[10px] tracking-widest text-gray-500 uppercase">
          &copy; {new Date().getFullYear()} Grupo Zakher. All rights reserved.
        </p>
      </footer>
        ...
        {showSticky && (
          ...
          >
            ...
            <div className="flex-1 md:hidden px-6 text-left">
              <span className="font-cormorant text-xl text-gray-900 leading-none">Grupo Zakher</span>
            </div>
